    ...
    <form>
      ...
      <div class="relative">
        ...
        <input
          ...
          v-model="search"
          id="default-search"
          class="sm:w-14 transition-all cursor-pointer block p-4 pl-2 text-sm text-white border border-gray-500 rounded-lg bg-gray-700 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
