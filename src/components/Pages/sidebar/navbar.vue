<template>
  <div>
    ...
    <div class="w-full flex ">
      <div
      id="Main"
      class=" min-h-screen transform xl:translate-x-0 ease-in-out transition duration-500 sm:w-64 flex justify-start items-start h-full w-full bg-gray-900 flex-col"
    >
      ...
      <div
        class="mt-6 flex flex-col justify-start items-center  w-full pb-5"
      >
        <div
